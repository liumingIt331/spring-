...
public interface AutowireCapableBeanFactory extends BeanFactory {
	...
	/**
	 * 没有自动装配的Bean
	 * 但是：仍然会采用 BeanFactoryAware 及 注解的方式注入
	 *
	...
	/**
	 * 表明通过Bean的class的内部来自动装配
	 *
	 * Constant that indicates determining an appropriate autowire strategy
	 * through introspection of the bean class.
	 * @see #createBean
	 * @see #autowire
	 * @deprecated （spring3.0被废弃）as of Spring 3.0: If you are using mixed autowiring strategies,
	 ...
	 * callbacks or perform any further initialization of the bean. This interface
	 * offers distinct, fine-grained operations for those purposes, for example
	 * {@link #initializeBean}. OrderHowever, {@link InstantiationAwareBeanPostProcessor}
